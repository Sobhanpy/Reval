...
from accounts.views.PasswordResetConfirm import PasswordResetConfirmView
from accounts.views.ResetPasswordDone import ResetDoneView
from accounts.views.Singup import SignUpView
